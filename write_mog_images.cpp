...
CVAPI(int) cvSaveHDF5(const char * fname, const CvArr * arr);
...
//	assert(start_frame >= 0);
	...
	//			cvSaveImage(str, im); 
				...
				sprintf(str, "%s/pfg/p%05d.h5", target_dir, i);
				double minval,maxval;
				cvMinMaxLoc(gauss->prob, &minval, &maxval);
				printf("max value = %f\n", maxval);
				cvScale(gauss->prob, prob8u, 255, 0);
				cvSaveHDF5(str, gauss->prob);
